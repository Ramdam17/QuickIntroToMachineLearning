...
- **NB 5 (the demanding case — handwritten digits, the visualization-first capstone) OPENED.** Branch
  ...
  **After it ships, close chapter 11 via PR `chapter/11_MLP → main` (`--no-ff`) on Rémy's explicit go.** Next:
