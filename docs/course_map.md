...
## 11_MLP  *(plan approved 2026-06-29; **NB 1–3 built**; five notebooks; the first method beyond trees; the single sigmoid neuron == ch 03 logistic regression, one hidden layer + backprop the new idea; ch 12 owns depth/representations/dropout)*
